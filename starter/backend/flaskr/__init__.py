...
#----------------------------------------------------------------------------#
  ...
  def add_questions():
    ...
    The values of 'question', 'answer', 'difficulty' and 'category' comes as json
...
#----------------------------------------------------------------------------#  
  ...
  def get_questions_by_category(category_id):
    """ 
    Method used to get a list of existing questions from the 'trivia' db by category
    HTTP:GET
    Args:
      int : category_id of the category for which the questions have to be displayed
    Returns:
      JSON : 
      { 
        "questions":
...
#---------------------------------------------------------------------------------#
# search a question by wild card from list of questions in db - supports pagination
#---------------------------------------------------------------------------------#

  @app.route("/questions/query" ,methods=["POST"])
  def question_search():
    """ 
    Method used to get a search for existing questions from the 'trivia' db by user
    given search term
    HTTP:POST
    Args:
      JSON : searchTerm 
...
#----------------------------------------------------------------------------#
  ...
  def after_request(response):
   """ 
    Method will be called after the request and adds the below paramteres in the 
    response headers.
